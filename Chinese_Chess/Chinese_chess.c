...
pieceStruct piece[32] = {
    ...
    {"相",2,0,redCamp,elephant,alive} , 
    {"仕",3,0,redCamp,shi,alive},  
    {"帥",4,0,redCamp,jiang,alive},  
    {"仕",5,0,redCamp,shi,alive},  
    {"相",6,0,redCamp,elephant,alive}, 
    {"马",7,0,redCamp,horse,alive},  
    {"車",8,0,redCamp,car,alive},  
    {"炮",1,2,redCamp,pao,alive}, 
    {"炮",7,2,redCamp,pao,alive}, 
    {"兵",0,3,redCamp,bing,alive},  
    {"兵",2,3,redCamp,bing,alive},  
    {"兵",4,3,redCamp,bing,alive},  
    {"兵",6,3,redCamp,bing,alive},  
    {"兵",8,3,redCamp,bing,alive}, 
    {"车",0,9,blackCamp,car,alive},  
    {"马",1,9,blackCamp,horse,alive},  
    {"象",2,9,blackCamp,elephant,alive} , 
    {"士",3,9,blackCamp,shi,alive},  
    {"将",4,9,blackCamp,jiang,alive},  
    {"士",5,9,blackCamp,shi,alive},  
    {"象",6,9,blackCamp,elephant,alive},  
    {"马",7,9,blackCamp,horse,alive},  
    {"车",8,9,blackCamp,car,alive},  
    {"炮",1,7,blackCamp,pao,alive},  
    {"炮",7,7,blackCamp,pao,alive},  
    {"卒",0,6,blackCamp,zu,alive}, 
    {"卒",2,6,blackCamp,zu,alive},  
    {"卒",4,6,blackCamp,zu,alive},  
...
static void piece_position(long int x,long int y)
{
    ...
    if (click_number==0) {
        ...
        if(chess == -1) return; //Selecting a blank chessboard will return
